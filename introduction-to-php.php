...
*/
	echo "<ul>";
	echo "<li>HTML - Stands for Hypertext Markup Language";
	echo "<br>";
	echo "<li>CSS - Stands for Cascading Stylesheet";
	echo "<br>";
	echo "<li>JS - Stands for JavaScript";
	echo "<br>";
	echo "<li>PHP - Stands for Hypertext Preprocessor";
	echo "<br>";
	echo "<li>SQL - Stands for Structural Query Language";
	echo "<br>";
	echo "</ul>";
